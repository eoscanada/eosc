...
func init() {
	...
	RootCmd.PersistentFlags().StringSliceP("permission", "p", []string{}, "Base URL to wallet endpoint. You can pass this multiple times to use the multi-signer (will use each wallet to sign multi-sig transactions).")
