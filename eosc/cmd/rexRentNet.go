...
var rexRentNet = &cobra.Command{
	...
	Short: "Rent Network for the account [receiver]. If you don't want to set up an automatic renewal upon expiry, enter 0 for [loan fund]. Otherwise you can set up an amount now, or use `eosc rex fundnetloan` to provide tokens to renew the loan.",
